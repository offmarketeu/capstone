...
fullcorpues<-corpues(fullCorpus)
...
gm2<- tokens_ngrams(tob, n = 2L, skip = 0L, concatenator = " ")
gm2_top<- topfeatures(dfm(gm2))
gm3<- tokens_ngrams(tob, n = 3L, skip = 0L, concatenator = " ")
gm3_top<- topfeatures(dfm(gm3))
gm4<- tokens_ngrams(tob, n = 4L, skip = 0L, concatenator = " ")
